...
create_ts <- function(data, column, start_year = 2013, start_month = 4, end_year = 2024, end_month = 3, frequency = 12) {
  ts(data[[column]], start = c(start_year, start_month), end = c(end_year, end_month), frequency = frequency)
}
```
